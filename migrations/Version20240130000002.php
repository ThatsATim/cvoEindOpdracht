 ...
 */
final class Version20240130000002 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE achievement (id INT AUTO_INCREMENT NOT NULL, game_id_id INT DEFAULT NULL, description VARCHAR(255) DEFAULT NULL, picture VARCHAR(255) DEFAULT NULL, date_unlocked DATETIME NOT NULL, INDEX IDX_96737FF14D77E7D8 (game_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE score (id INT AUTO_INCREMENT NOT NULL, game_id_id INT DEFAULT NULL, player_id_id INT DEFAULT NULL, time DATETIME NOT NULL, score VARCHAR(255) NOT NULL, INDEX IDX_329937514D77E7D8 (game_id_id), INDEX IDX_32993751C036E511 (player_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, username VARCHAR(180) NOT NULL, roles JSON NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, gender VARCHAR(255) NOT NULL, birthday DATETIME DEFAULT NULL, picture VARCHAR(255) DEFAULT NULL, is_banned TINYINT(1) NOT NULL, is_admin TINYINT(1) NOT NULL, is_muted TINYINT(1) NOT NULL, is_friend_invite_blocked TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_8D93D649F85E0677 (username), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
